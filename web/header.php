...
<div class="brand">
    ...
    <a href="javascript:void(0)" class="logo">HR PANEL</a>
    ...
    <ul class="nav top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
                ...
                <li class="external">
                    <a href="javascript:void(0)">See All Tasks</a>
                </li>
            </ul>
        </li>
        <!-- settings end -->
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
					...
					<li><a href="#deleted">All Rejected</a></li>
					<li><a href="#onboarded">All Onboarded</a></li>
                    </ul>
                </li>
